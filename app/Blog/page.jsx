...
import Store1 from '../../public/BlogPic.png'
import Store2 from '../../public/BlogPic2.png'
...
export default function page() {
  ...
  <h1 className='text-4xl text-indigo-500'>Blog App</h1>
<p>In my blog, I aim to share valuable insights, knowledge, and experiences on a wide range of topics. With a passion for writing and a thirst for learning, I strive to create informative and engaging content that resonates with my readers.

Covering diverse subjects such as technology, lifestyle, travel, health, and more, my blog serves as a platform to explore and discuss various aspects of life. Through well-researched articles, thought-provoking essays, and engaging storytelling, I aim to inform, entertain, and inspire my audience.</p>
</div>
